...
<?php
//http://onibusemponto.com/api2/proximoBusComp/?ponto=910000871&sl=1&linha=1156-10
...
if($proximosOnibus != null){
	...
	$i = 0;
	foreach ($proximosOnibus as &$bus) {
		$json .= '{"prefixo" : '.$bus[0].', "latitude" : '.$bus[1].', "longitude" : '.$bus[2].', "rua" : "'.$bus[3].'", "numero" : "'.$bus[4].'", "distancia_texto" : "'.$bus[5].'", "distancia_valor" : '.$bus[6].'}, ';
		$i += 1;
	}
	$json .= '] }';
